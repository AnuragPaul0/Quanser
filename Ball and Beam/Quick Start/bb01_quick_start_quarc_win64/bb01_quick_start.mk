###########################################################################
## Makefile generated for component 'bb01_quick_start'. 
## 
## Makefile     : bb01_quick_start.mk
## Generated on : Sun May 21 23:22:21 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\bb01_quick_start.rt-win64
...
PRODUCT_NAME              = bb01_quick_start
MAKEFILE                  = bb01_quick_start.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2021b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2021b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\Dell\Desktop\Quanser\BALLAN~1\QUICKS~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = bb01_quick_start_comp.rsp
CMD_FILE                  = bb01_quick_start.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\bb01_quick_start.rt-win64
...
DEFINES_STANDARD = -DMODEL=bb01_quick_start -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\bb01_quick_start_quarc_win64\bb01_quick_start.c $(START_DIR)\bb01_quick_start_quarc_win64\bb01_quick_start_data.c $(START_DIR)\bb01_quick_start_quarc_win64\bb01_quick_start_main.c $(START_DIR)\bb01_quick_start_quarc_win64\rtGetInf.c $(START_DIR)\bb01_quick_start_quarc_win64\rtGetNaN.c $(START_DIR)\bb01_quick_start_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = bb01_quick_start.obj bb01_quick_start_data.obj bb01_quick_start_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\bb01_quick_start_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\bb01_quick_start_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
bb01_quick_start.obj : $(START_DIR)\bb01_quick_start_quarc_win64\bb01_quick_start.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\bb01_quick_start_quarc_win64\bb01_quick_start.c


bb01_quick_start_data.obj : $(START_DIR)\bb01_quick_start_quarc_win64\bb01_quick_start_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\bb01_quick_start_quarc_win64\bb01_quick_start_data.c


bb01_quick_start_main.obj : $(START_DIR)\bb01_quick_start_quarc_win64\bb01_quick_start_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\bb01_quick_start_quarc_win64\bb01_quick_start_main.c


rtGetInf.obj : $(START_DIR)\bb01_quick_start_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\bb01_quick_start_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\bb01_quick_start_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\bb01_quick_start_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\bb01_quick_start_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\bb01_quick_start_quarc_win64\rt_nonfinite.c
