...
#ifndef RTW_HEADER_bb01_quick_start_h_
#define RTW_HEADER_bb01_quick_start_h_
#include <string.h>
#ifndef bb01_quick_start_COMMON_INCLUDES_
#define bb01_quick_start_COMMON_INCLUDES_
#include <math.h>
#include "rtwtypes.h"
...
#endif                                 /* bb01_quick_start_COMMON_INCLUDES_ */

#include "bb01_quick_start_types.h"
...
#define bb01_quick_start_rtModel       RT_MODEL_bb01_quick_start_T

/* Block signals (default storage) */
typedef struct {
  real_T mtocm[2];                     /* '<Root>/m to cm' */
  real_T ServoGain;                    /* '<Root>/Servo Gain' */
  real_T mtocm_e;                      /* '<Root>/m to cm ' */
  real_T Radiantodegree;               /* '<Root>/Radian  to degree ' */
} B_bb01_quick_start_T;
...
typedef struct {
  ...
  real_T HILReadTimebase_AnalogBuffer[2];/* '<Root>/HIL Read Timebase' */
  ...
  struct {
    void *LoggedData;
  } CommandVoltage_PWORK;              /* '<Root>/Command Voltage' */

  void *HILWrite_PWORK;                /* '<Root>/HIL Write' */
  struct {
    void *LoggedData;
  } RemoteSensorBallPositioncm_PWOR;
                                 /* '<Root>/Remote Sensor Ball Position (cm)' */
...
} DW_bb01_quick_start_T;

/* Backward compatible GRT Identifiers */
#define rtB                            bb01_quick_start_B
#define BlockIO                        B_bb01_quick_start_T
#define rtP                            bb01_quick_start_P
#define Parameters                     P_bb01_quick_start_T
#define rtDWork                        bb01_quick_start_DW
#define D_Work                         DW_bb01_quick_start_T

/* Parameters (default storage) */
struct P_bb01_quick_start_T_ {
  ...
  real_T SmoothSignalGenerator_Frequency;/* Expression: i_frequency
                                          * Referenced by: '<Root>/Smooth Signal Generator'
                                          */
  real_T SS01CalibrationmV_Gain;       /* Expression: -0.0425
                                        * Referenced by: '<Root>/SS01 Calibration  (m//V)'
                                        */
  real_T BB01CalibrationmV_Gain;       /* Expression: -0.0425
                                        * Referenced by: '<Root>/BB01 Calibration  (m//V)'
                                        */
  real_T mtocm_Gain;                   /* Expression: 100
                                        * Referenced by: '<Root>/m to cm'
                                        */
  real_T ProportionalGain_Gain;        /* Expression: 15
  ...
  real_T DiscreteTransferFcn_InitialStat;/* Expression: 0
                                          * Referenced by: '<S2>/Discrete Transfer Fcn'
                                          */
  real_T DerivativeGain_Gain;          /* Expression: 7
                                        * Referenced by: '<Root>/Derivative Gain'
                                        */
  real_T Saturation_UpperSat;          /* Expression: 0.9774
                                        * Referenced by: '<Root>/Saturation'
                                        */
  real_T Saturation_LowerSat;          /* Expression: -0.9774
                                        * Referenced by: '<Root>/Saturation'
                                        */
  real_T Counttorad_Gain;              /* Expression: 0.0015
                                        * Referenced by: '<Root>/Count to rad'
                                        */
  real_T Subtract56deg_Bias;           /* Expression: -56*pi/180
                                        * Referenced by: '<Root>/Subtract 56 deg'
                                        */
  real_T ServoGain_Gain;               /* Expression: -12
                                        * Referenced by: '<Root>/Servo Gain'
                                        */
  real_T mtocm_Gain_a;                 /* Expression: 100
                                        * Referenced by: '<Root>/m to cm '
                                        */
  ...
  uint8_T HILReadTimebase_OverflowMode;
                              ...
                              * Referenced by: '<Root>/HIL Read Timebase'
                              */
  uint8_T SPSource_CurrentSetting;/* Computed Parameter: SPSource_CurrentSetting
                                   * Referenced by: '<Root>/S.P. Source'
                                   */
};

/* Real-time Model Data Structure */
struct tag_RTM_bb01_quick_start_T {
  const char_T *path;
...
extern P_bb01_quick_start_T bb01_quick_start_P;

/* Block signals (default storage) */
extern B_bb01_quick_start_T bb01_quick_start_B;

/* Block states (default storage) */
extern DW_bb01_quick_start_T bb01_quick_start_DW;

/* Model entry point functions */
extern void bb01_quick_start_initialize(void);
extern void bb01_quick_start_output(void);
extern void bb01_quick_start_update(void);
extern void bb01_quick_start_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern bb01_quick_start_rtModel *bb01_quick_start(void);
...
extern RT_MODEL_bb01_quick_start_T *const bb01_quick_start_M;
 ...
 *
 * '<Root>' : 'bb01_quick_start'
 * '<S1>'   : 'bb01_quick_start/Amplitude  (cm)'
 * '<S2>'   : 'bb01_quick_start/High-Pass Filter'
 */
#endif                                 /* RTW_HEADER_bb01_quick_start_h_ */
