###########################################################################
## Makefile generated for component 'quarc_sine_scope_demo'. 
## 
## Makefile     : quarc_sine_scope_demo.mk
## Generated on : Wed Dec 21 05:17:01 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\quarc_sine_scope_demo.rt-win64
...
COMPILER_COMMAND_FILE     = quarc_sine_scope_demo_comp.rsp
CMD_FILE                  = quarc_sine_scope_demo.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\quarc_sine_scope_demo.rt-win64
...
DEFINES_STANDARD = -DMODEL=quarc_sine_scope_demo -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\quarc_sine_scope_demo_quarc_win64\quarc_sine_scope_demo.c $(START_DIR)\quarc_sine_scope_demo_quarc_win64\quarc_sine_scope_demo_data.c $(START_DIR)\quarc_sine_scope_demo_quarc_win64\quarc_sine_scope_demo_main.c $(START_DIR)\quarc_sine_scope_demo_quarc_win64\rtGetInf.c $(START_DIR)\quarc_sine_scope_demo_quarc_win64\rtGetNaN.c $(START_DIR)\quarc_sine_scope_demo_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = quarc_sine_scope_demo.obj quarc_sine_scope_demo_data.obj quarc_sine_scope_demo_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\quarc_sine_scope_demo_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\quarc_sine_scope_demo_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
quarc_sine_scope_demo.obj : $(START_DIR)\quarc_sine_scope_demo_quarc_win64\quarc_sine_scope_demo.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\quarc_sine_scope_demo_quarc_win64\quarc_sine_scope_demo.c


quarc_sine_scope_demo_data.obj : $(START_DIR)\quarc_sine_scope_demo_quarc_win64\quarc_sine_scope_demo_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\quarc_sine_scope_demo_quarc_win64\quarc_sine_scope_demo_data.c


quarc_sine_scope_demo_main.obj : $(START_DIR)\quarc_sine_scope_demo_quarc_win64\quarc_sine_scope_demo_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\quarc_sine_scope_demo_quarc_win64\quarc_sine_scope_demo_main.c


rtGetInf.obj : $(START_DIR)\quarc_sine_scope_demo_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\quarc_sine_scope_demo_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\quarc_sine_scope_demo_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\quarc_sine_scope_demo_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\quarc_sine_scope_demo_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\quarc_sine_scope_demo_quarc_win64\rt_nonfinite.c
