...
RT_MODEL_s_bb01_pos_T *s_bb01_pos(void)
{
  ...
  rtmSetTFinal(s_bb01_pos_M, -1);
  s_bb01_pos_M->Timing.stepSize0 = 0.002;
  s_bb01_pos_M->Timing.stepSize1 = 0.002;

  /* External mode info */
  s_bb01_pos_M->Sizes.checksums[0] = (253096066U);
  s_bb01_pos_M->Sizes.checksums[1] = (3786206437U);
  s_bb01_pos_M->Sizes.checksums[2] = (1581647296U);
  s_bb01_pos_M->Sizes.checksums[3] = (3111862015U);
