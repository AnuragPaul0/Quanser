...
typedef RT_MODEL_s_bb01_pos_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * s_bb01_pos(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(s_bb01_pos_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://s_bb01_pos:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: s_bb01_pos -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
