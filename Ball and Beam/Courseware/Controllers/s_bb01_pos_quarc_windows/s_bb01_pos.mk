###########################################################################
## Makefile generated for component 's_bb01_pos'. 
## 
## Makefile     : s_bb01_pos.mk
## Generated on : Mon Jun 12 22:29:24 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\s_bb01_pos.rt-windows
...
COMPILER_COMMAND_FILE     = s_bb01_pos_comp.rsp
CMD_FILE                  = s_bb01_pos.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\s_bb01_pos.rt-windows
...
DEFINES_STANDARD = -DMODEL=s_bb01_pos -DNUMST=2 -DNCSTATES=7 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\s_bb01_pos_quarc_windows\rtGetInf.c $(START_DIR)\s_bb01_pos_quarc_windows\rtGetNaN.c $(START_DIR)\s_bb01_pos_quarc_windows\rt_nonfinite.c $(START_DIR)\s_bb01_pos_quarc_windows\s_bb01_pos.c $(START_DIR)\s_bb01_pos_quarc_windows\s_bb01_pos_data.c $(START_DIR)\s_bb01_pos_quarc_windows\s_bb01_pos_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj s_bb01_pos.obj s_bb01_pos_data.obj s_bb01_pos_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\s_bb01_pos_quarc_windows}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\s_bb01_pos_quarc_windows}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : $(START_DIR)\s_bb01_pos_quarc_windows\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\s_bb01_pos_quarc_windows\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\s_bb01_pos_quarc_windows\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\s_bb01_pos_quarc_windows\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\s_bb01_pos_quarc_windows\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\s_bb01_pos_quarc_windows\rt_nonfinite.c


s_bb01_pos.obj : $(START_DIR)\s_bb01_pos_quarc_windows\s_bb01_pos.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\s_bb01_pos_quarc_windows\s_bb01_pos.c


s_bb01_pos_data.obj : $(START_DIR)\s_bb01_pos_quarc_windows\s_bb01_pos_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\s_bb01_pos_quarc_windows\s_bb01_pos_data.c


s_bb01_pos_main.obj : $(START_DIR)\s_bb01_pos_quarc_windows\s_bb01_pos_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\s_bb01_pos_quarc_windows\s_bb01_pos_main.c
