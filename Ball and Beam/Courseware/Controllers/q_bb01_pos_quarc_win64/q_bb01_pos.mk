...
## Generated on : Fri Jan 16 17:24:59 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\q_bb01_pos.rt-win64
...
START_DIR                 = C:\Users\Dell\Desktop\QUANSE~1\BALLAN~1\COURSE~1\CONTRO~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\q_bb01_pos.rt-win64
...
SRCS = $(START_DIR)\q_bb01_pos_quarc_win64\q_bb01_pos.c $(START_DIR)\q_bb01_pos_quarc_win64\q_bb01_pos_data.c $(START_DIR)\q_bb01_pos_quarc_win64\q_bb01_pos_main.c $(START_DIR)\q_bb01_pos_quarc_win64\rtGetInf.c $(START_DIR)\q_bb01_pos_quarc_win64\rtGetNaN.c $(START_DIR)\q_bb01_pos_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
{$(START_DIR)\q_bb01_pos_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\q_bb01_pos_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
q_bb01_pos.obj : $(START_DIR)\q_bb01_pos_quarc_win64\q_bb01_pos.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_bb01_pos_quarc_win64\q_bb01_pos.c


q_bb01_pos_data.obj : $(START_DIR)\q_bb01_pos_quarc_win64\q_bb01_pos_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_bb01_pos_quarc_win64\q_bb01_pos_data.c


q_bb01_pos_main.obj : $(START_DIR)\q_bb01_pos_quarc_win64\q_bb01_pos_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_bb01_pos_quarc_win64\q_bb01_pos_main.c


rtGetInf.obj : $(START_DIR)\q_bb01_pos_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_bb01_pos_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\q_bb01_pos_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_bb01_pos_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\q_bb01_pos_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_bb01_pos_quarc_win64\rt_nonfinite.c
