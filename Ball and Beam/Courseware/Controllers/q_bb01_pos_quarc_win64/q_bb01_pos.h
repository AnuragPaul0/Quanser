...
#define q_bb01_pos_rtModel             RT_MODEL_q_bb01_pos_T
...
typedef struct {
  ...
  real_T EncoderCalibrationradcount;
                                  /* '<S8>/Encoder Calibration  (rad//count)' */
  real_T Bias;                         /* '<S8>/Bias' */
  ...
  real_T DirectionConventionRightHandsys;
                         /* '<S12>/Direction Convention: (Right-Hand) system' */
...
typedef struct {
  ...
  int32_T HILInitialize_DOStates[8];   /* '<S8>/HIL Initialize' */
...
#define rtB                            q_bb01_pos_B
#define BlockIO                        B_q_bb01_pos_T
#define rtX                            q_bb01_pos_X
#define ContinuousStates               X_q_bb01_pos_T
#define rtXdot                         q_bb01_pos_XDot
#define StateDerivatives               XDot_q_bb01_pos_T
#define tXdis                          q_bb01_pos_XDis
#define StateDisabled                  XDis_q_bb01_pos_T
#define rtP                            q_bb01_pos_P
#define Parameters                     P_q_bb01_pos_T
#define rtDWork                        q_bb01_pos_DW
#define D_Work                         DW_q_bb01_pos_T
...
struct P_q_bb01_pos_T_ {
  ...
  uint8_T HILReadAnalogTimebase_OverflowM;
                           ...
                           * Referenced by: '<S8>/HIL Read Analog Timebase'
                           */
  uint8_T SetpointSource_CurrentSetting;
...
extern void q_bb01_pos_output(void);
extern void q_bb01_pos_update(void);
extern void q_bb01_pos_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_bb01_pos_rtModel *q_bb01_pos(void);
