...
#ifndef RTW_HEADER_quarc_analog_loopback_demo_h_
#define RTW_HEADER_quarc_analog_loopback_demo_h_
#include <math.h>
#include <string.h>
#ifndef quarc_analog_loopback_demo_COMMON_INCLUDES_
#define quarc_analog_loopback_demo_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                         /* quarc_analog_loopback_demo_COMMON_INCLUDES_ */

#include "quarc_analog_loopback_demo_types.h"
...
#define quarc_analog_loopback_demo_rtModel RT_MODEL_quarc_analog_loopbac_T

/* Block signals (default storage) */
typedef struct {
  real_T HILReadAnalog_o1;             /* '<Root>/HIL Read Analog' */
  real_T HILReadAnalog_o2;             /* '<Root>/HIL Read Analog' */
  real_T SignalGenerator;              /* '<Root>/Signal Generator' */
  real_T SignalGenerator1;             /* '<Root>/Signal Generator1' */
} B_quarc_analog_loopback_demo_T;
...
} DW_quarc_analog_loopback_demo_T;

/* Backward compatible GRT Identifiers */
#define rtB                            quarc_analog_loopback_demo_B
#define BlockIO                        B_quarc_analog_loopback_demo_T
#define rtP                            quarc_analog_loopback_demo_P
#define Parameters                     P_quarc_analog_loopback_demo_T
#define rtDWork                        quarc_analog_loopback_demo_DW
#define D_Work                         DW_quarc_analog_loopback_demo_T

/* Parameters (default storage) */
struct P_quarc_analog_loopback_demo_T_ {
...
struct tag_RTM_quarc_analog_loopback_T {
  const char_T *path;
...
extern P_quarc_analog_loopback_demo_T quarc_analog_loopback_demo_P;

/* Block signals (default storage) */
extern B_quarc_analog_loopback_demo_T quarc_analog_loopback_demo_B;

/* Block states (default storage) */
extern DW_quarc_analog_loopback_demo_T quarc_analog_loopback_demo_DW;

/* Model entry point functions */
extern void quarc_analog_loopback_demo_initialize(void);
extern void quarc_analog_loopback_demo_output(void);
extern void quarc_analog_loopback_demo_update(void);
extern void quarc_analog_loopback_demo_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern quarc_analog_loopback_demo_rtModel *quarc_analog_loopback_demo(void);
...
extern RT_MODEL_quarc_analog_loopbac_T *const quarc_analog_loopback_demo_M;
 ...
 *
 * '<Root>' : 'quarc_analog_loopback_demo'
 */
#endif                            /* RTW_HEADER_quarc_analog_loopback_demo_h_ */
