###########################################################################
## Makefile generated for component 'quarc_analog_loopback_demo'. 
## 
## Makefile     : quarc_analog_loopback_demo.mk
## Generated on : Fri Dec 23 03:47:10 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\quarc_analog_loopback_demo.rt-win64
...
PRODUCT_NAME              = quarc_analog_loopback_demo
MAKEFILE                  = quarc_analog_loopback_demo.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2021b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2021b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\Dell\Desktop\Quanser\BALLAN~1\COURSE~1\CONTRO~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = quarc_analog_loopback_demo_comp.rsp
CMD_FILE                  = quarc_analog_loopback_demo.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\quarc_analog_loopback_demo.rt-win64
...
DEFINES_STANDARD = -DMODEL=quarc_analog_loopback_demo -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\quarc_analog_loopback_demo.c $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\quarc_analog_loopback_demo_data.c $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\quarc_analog_loopback_demo_main.c $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\rtGetInf.c $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\rtGetNaN.c $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = quarc_analog_loopback_demo.obj quarc_analog_loopback_demo_data.obj quarc_analog_loopback_demo_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\quarc_analog_loopback_demo_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\quarc_analog_loopback_demo_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
quarc_analog_loopback_demo.obj : $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\quarc_analog_loopback_demo.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\quarc_analog_loopback_demo.c


quarc_analog_loopback_demo_data.obj : $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\quarc_analog_loopback_demo_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\quarc_analog_loopback_demo_data.c


quarc_analog_loopback_demo_main.obj : $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\quarc_analog_loopback_demo_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\quarc_analog_loopback_demo_main.c


rtGetInf.obj : $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\quarc_analog_loopback_demo_quarc_win64\rt_nonfinite.c
