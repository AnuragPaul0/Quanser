...
#ifndef RTW_HEADER_Ball_Beam_testing_h_
#define RTW_HEADER_Ball_Beam_testing_h_
#include <string.h>
#ifndef Ball_Beam_testing_COMMON_INCLUDES_
#define Ball_Beam_testing_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Ball_Beam_testing_COMMON_INCLUDES_ */

#include "Ball_Beam_testing_types.h"
...
#define Ball_Beam_testing_rtModel      RT_MODEL_Ball_Beam_testing_T

/* Block signals (default storage) */
typedef struct {
  real_T HILReadAnalogTimebase_o1;     /* '<Root>/HIL Read Analog Timebase' */
  real_T SS01CalibrationmV;            /* '<Root>/SS01 Calibration  (m//V)' */
  real_T cmm[2];                       /* '<Root>/cm//m' */
  real_T Gain[2];                      /* '<S3>/Gain' */
  real_T DACBSaturationV;              /* '<S1>/DACB Saturation (V)' */
  uint8_T Compare;                     /* '<S6>/Compare' */
} B_Ball_Beam_testing_T;
...
} DW_Ball_Beam_testing_T;

/* External outputs (root outports fed by signals with default storage) */
typedef struct {
  real_T xm;                           /* '<Root>/x (m)' */
  real_T theta_lrad;                   /* '<Root>/theta_l (rad)' */
  real_T x_dm;                         /* '<Root>/x_d (m)' */
  real_T VmV;                          /* '<Root>/Vm (V)' */
} ExtY_Ball_Beam_testing_T;

/* Backward compatible GRT Identifiers */
#define rtB                            Ball_Beam_testing_B
#define BlockIO                        B_Ball_Beam_testing_T
#define rtY                            Ball_Beam_testing_Y
#define ExternalOutputs                ExtY_Ball_Beam_testing_T
#define rtP                            Ball_Beam_testing_P
#define Parameters                     P_Ball_Beam_testing_T
#define rtDWork                        Ball_Beam_testing_DW
#define D_Work                         DW_Ball_Beam_testing_T

/* Parameters (default storage) */
struct P_Ball_Beam_testing_T_ {
...
struct tag_RTM_Ball_Beam_testing_T {
  const char_T *path;
...
extern P_Ball_Beam_testing_T Ball_Beam_testing_P;

/* Block signals (default storage) */
extern B_Ball_Beam_testing_T Ball_Beam_testing_B;

/* Block states (default storage) */
extern DW_Ball_Beam_testing_T Ball_Beam_testing_DW;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_Ball_Beam_testing_T Ball_Beam_testing_Y;

/* Model entry point functions */
extern void Ball_Beam_testing_initialize(void);
extern void Ball_Beam_testing_output(void);
extern void Ball_Beam_testing_update(void);
extern void Ball_Beam_testing_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Ball_Beam_testing_rtModel *Ball_Beam_testing(void);
...
extern RT_MODEL_Ball_Beam_testing_T *const Ball_Beam_testing_M;
 ...
 *
 * '<Root>' : 'Ball_Beam_testing'
 * '<S1>'   : 'Ball_Beam_testing/Actuator Dynamics'
 * '<S2>'   : 'Ball_Beam_testing/Constant  (cm)'
 * '<S3>'   : 'Ball_Beam_testing/Radians to Degrees'
 * '<S4>'   : 'Ball_Beam_testing/Sensor Deadband  Detection'
 * '<S5>'   : 'Ball_Beam_testing/Sensor Deadband  Detection/Initial Time (s)'
 * '<S6>'   : 'Ball_Beam_testing/Sensor Deadband  Detection/Reading Zero?'
 */
#endif                                 /* RTW_HEADER_Ball_Beam_testing_h_ */
