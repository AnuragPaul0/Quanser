###########################################################################
## Makefile generated for component 'Ball_Beam_testing'. 
## 
## Makefile     : Ball_Beam_testing.mk
## Generated on : Thu Mar 14 16:07:38 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Ball_Beam_testing.rt-win64
...
PRODUCT_NAME              = Ball_Beam_testing
MAKEFILE                  = Ball_Beam_testing.mk
...
COMPILER_COMMAND_FILE     = Ball_Beam_testing_comp.rsp
CMD_FILE                  = Ball_Beam_testing.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Ball_Beam_testing.rt-win64
...
DEFINES_STANDARD = -DMODEL=Ball_Beam_testing -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Ball_Beam_testing_quarc_win64\Ball_Beam_testing.c $(START_DIR)\Ball_Beam_testing_quarc_win64\Ball_Beam_testing_data.c $(START_DIR)\Ball_Beam_testing_quarc_win64\Ball_Beam_testing_main.c $(START_DIR)\Ball_Beam_testing_quarc_win64\rtGetInf.c $(START_DIR)\Ball_Beam_testing_quarc_win64\rtGetNaN.c $(START_DIR)\Ball_Beam_testing_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Ball_Beam_testing.obj Ball_Beam_testing_data.obj Ball_Beam_testing_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Ball_Beam_testing_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Ball_Beam_testing_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Ball_Beam_testing.obj : $(START_DIR)\Ball_Beam_testing_quarc_win64\Ball_Beam_testing.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Ball_Beam_testing_quarc_win64\Ball_Beam_testing.c


Ball_Beam_testing_data.obj : $(START_DIR)\Ball_Beam_testing_quarc_win64\Ball_Beam_testing_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Ball_Beam_testing_quarc_win64\Ball_Beam_testing_data.c


Ball_Beam_testing_main.obj : $(START_DIR)\Ball_Beam_testing_quarc_win64\Ball_Beam_testing_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Ball_Beam_testing_quarc_win64\Ball_Beam_testing_main.c


rtGetInf.obj : $(START_DIR)\Ball_Beam_testing_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Ball_Beam_testing_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\Ball_Beam_testing_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Ball_Beam_testing_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\Ball_Beam_testing_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Ball_Beam_testing_quarc_win64\rt_nonfinite.c
