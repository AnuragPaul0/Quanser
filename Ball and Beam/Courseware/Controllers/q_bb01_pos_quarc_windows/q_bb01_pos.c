...
RT_MODEL_q_bb01_pos_T *q_bb01_pos(void)
{
  ...
  /* External mode info */
  q_bb01_pos_M->Sizes.checksums[0] = (439088604U);
  q_bb01_pos_M->Sizes.checksums[1] = (4029612288U);
  q_bb01_pos_M->Sizes.checksums[2] = (3286138189U);
  q_bb01_pos_M->Sizes.checksums[3] = (1685086224U);
