###########################################################################
## Makefile generated for component 'q_bb01_pos'. 
## 
## Makefile     : q_bb01_pos.mk
## Generated on : Fri Dec 23 00:07:35 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\q_bb01_pos.rt-windows
...
COMPILER_COMMAND_FILE     = q_bb01_pos_comp.rsp
CMD_FILE                  = q_bb01_pos.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\q_bb01_pos.rt-windows
...
DEFINES_STANDARD = -DMODEL=q_bb01_pos -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\q_bb01_pos_quarc_windows\q_bb01_pos.c $(START_DIR)\q_bb01_pos_quarc_windows\q_bb01_pos_data.c $(START_DIR)\q_bb01_pos_quarc_windows\q_bb01_pos_main.c $(START_DIR)\q_bb01_pos_quarc_windows\rtGetInf.c $(START_DIR)\q_bb01_pos_quarc_windows\rtGetNaN.c $(START_DIR)\q_bb01_pos_quarc_windows\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = q_bb01_pos.obj q_bb01_pos_data.obj q_bb01_pos_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
LIBS = C:\PROGRA~1\Quanser\QUARC\lib\windows\hil.lib C:\PROGRA~1\Quanser\QUARC\lib\windows\QUDCFC~1.LIB C:\PROGRA~1\Quanser\QUARC\lib\windows\QUANSE~3.LIB
...
{$(START_DIR)\q_bb01_pos_quarc_windows}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\q_bb01_pos_quarc_windows}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
q_bb01_pos.obj : $(START_DIR)\q_bb01_pos_quarc_windows\q_bb01_pos.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_bb01_pos_quarc_windows\q_bb01_pos.c


q_bb01_pos_data.obj : $(START_DIR)\q_bb01_pos_quarc_windows\q_bb01_pos_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_bb01_pos_quarc_windows\q_bb01_pos_data.c


q_bb01_pos_main.obj : $(START_DIR)\q_bb01_pos_quarc_windows\q_bb01_pos_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_bb01_pos_quarc_windows\q_bb01_pos_main.c


rtGetInf.obj : $(START_DIR)\q_bb01_pos_quarc_windows\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_bb01_pos_quarc_windows\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\q_bb01_pos_quarc_windows\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_bb01_pos_quarc_windows\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\q_bb01_pos_quarc_windows\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_bb01_pos_quarc_windows\rt_nonfinite.c
