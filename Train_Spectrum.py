...
# command line
py.arg('--dataset', default='custom', choices=['cifar10', 'fashion_mnist', 'mnist', 'celeba', 'anime', 'custom'])
...
if args.dataset in ['cifar10', 'fashion_mnist', 'mnist']:  # 32x32
    ...
    # =               custom               =
    # ======================================
    img_paths = '/content/data/img_align_celeba/RealVideo-RealAudio/African/women/id00220/00027_faces'
                # image paths of custom dataset
    data_loader = data.make_custom_dataset(img_paths, args.batch_size, pin_memory=use_gpu)
    n_G_upsamplings = n_D_downsamplings = 5  # 3 for 32x32 and 4 for 64x64
    # ======================================
    # =               custom               =
    # ======================================
